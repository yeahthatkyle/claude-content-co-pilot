...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "AI content engine for the Corpay marketing team, powered by Claude." },
      { name: "author", content: "Corpay Marketing" },
      { property: "og:title", content: "Corpay Content Engine" },
      { property: "og:description", content: "AI content engine for the Corpay marketing team, powered by Claude." },
